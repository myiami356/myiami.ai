...
<body>
  ...
  <div class="container mt-4">
    <div class="p-5 text-dark  d-flex align-items-center position-relative" style="border-top: 4px solid blue; 
  ...
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
    ...
    <div class="col">
      <div class="card p-3  bg-light" 
           style="border-top: 4px solid blue; border-right: 4px solid blue; 
                  border-radius: 0 0 50px 10px;">
